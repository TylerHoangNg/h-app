...
function preload() {
    this.load.image("tiles", "./assets/tilemaps2/tiled7/TileModel_1.png");
    this.load.tilemapTiledJSON("map", "./assets/tilemaps2/tiled7/tiled7.json");

    this.load.atlas("FirstFemail", "./assets/character/FirstFemail0.1/FirstFemail0.1.png", "./assets/character/FirstFemail0.1/FirstFemail0.1.json");
}
...
function create() {
  ...
  const spawnPoint = map.findObject("Script", obj => obj.name === "spawnpoint");
...
function update(time, delta) {
  ...
  if (cursors.left.isDown) {
    ...
    if (prevVelocity.x < 0) player.setTexture("FirstFemail", "FirstFemail 0-4"); // left
    else if (prevVelocity.x > 0) player.setTexture("FirstFemail", "FirstFemail 0-8"); // right
    else if (prevVelocity.y < 0) player.setTexture("FirstFemail", "FirstFemail 0-12"); // back
    else if (prevVelocity.y > 0) player.setTexture("FirstFemail", "FirstFemail 0-0"); // front
  }
}